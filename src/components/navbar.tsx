...
const components: { title: string; href: string; description: string }[] = [
    {
        ...
        description:
            "A giude to help you use our api without any hassle.",
    },
    {
        title: "All Pokemon List",
        href: "/docs/api/pokemon-list",
        description:
            "Access a list of all the pokemons available in our database.",
    },
    {
        title: "Progress",
...
export function NavBar() {
    ...
    return (
        <nav className="flex justify-around py-1 border-b-2 h-12">
                ...
                <NavigationMenuList>
                        ...
                        <NavigationMenuContent>
                            <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                    ...
                                    <NavigationMenuLink asChild>
                                        ...
                                        >
                                            ...
                                            <p className="text-sm leading-tight text-muted-foreground">
                                                Beautifully designed webpages to deliver all the PokeData in an graphical view.
                                            </p>
                                        </a>
                                    </NavigationMenuLink>
                                </li>
                                ...
                                <ListItem href="/pokedex/types" title="Types">
                                    Get to know all the various types that Pocket Monters belong to.
                                </ListItem>
                    ...
                    <NavigationMenuItem>
                        <Link href="/docs" legacyBehavior passHref>
                            <NavigationMenuLink onClick={randomRoute} className={navigationMenuTriggerStyle()}>
                                Random
                            </NavigationMenuLink>
                        </Link>
                    </NavigationMenuItem>
